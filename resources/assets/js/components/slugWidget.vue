...
<template>
     <div class="slug-widget">
        <div class="icon-wrapper wrapper">
          ...
          ><span class="slug-edit"
                 v-show="isEditing"><input type="text" name="slug" class="input is-small" v-show="isEditing"
                                           v-model="customSlug"></span>
          </div>
         
         <div class="button-wrapper wrapper">
             <button class="save-slug-button button is-small" v-show="!isEditing " @click.prevent="editSlug">Edit
             </button>
